...
#
# Pinned by digest for the 0.1.0.0 release so an install is reproducible from a
# fixed, tested image set. Both are multi-arch (linux/amd64 + linux/arm64).
#   APP_IMAGE     paulscode/agent-wallet:0.1.0.0
#   GATEWAY_IMAGE paulscode/agent-wallet-bolt12-gateway:0.1.0.0
# Override for a dev build, e.g. --build-arg APP_IMAGE=paulscode/agent-wallet:edge
ARG APP_IMAGE=paulscode/agent-wallet@sha256:6275dc0ed98b13b2c0e679cef3ab72194ee11e720b0e8d6e7b4bf408d7380c27
ARG GATEWAY_IMAGE=paulscode/agent-wallet-bolt12-gateway@sha256:4a59ff5cda4a953cead32507ec9556a4803060fa76cc3f1d6c227271089e9595
